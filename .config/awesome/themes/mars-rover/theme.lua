--[[
     ...
     Custom theme, based on Powerarrow Awesome WM theme
     github.com/lcpz
...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/mars-rover"
theme.wallpaper                                 = theme.dir .. "/wall.png"
theme.font                                      = "Terminus 11"
theme.fg_normal                                 = "#FEFEFE"
theme.fg_focus                                  = "#F9A825" --"#32D6FF"
theme.fg_urgent                                 = "#C83F11"
theme.bg_normal                                 = "#222222"
theme.bg_focus                                  = "#1E2320"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#F9A825" --"#00CCFF"
--theme.taglist_font                              = "Font Awesome"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = theme.taglist_fg_focus -- "#00CCFF"
theme.border_width                              = 1
theme.border_normal                             = "#3F3F3F"
theme.border_focus                              = "#6F6F6F"
theme.border_marked                             = "#CC9393"
theme.titlebar_fg_focus                         = theme.taglist_fg_focus-- "#3F3F3F"
theme.titlebar_fg_normal                        = theme.bg_normal-- "#3F3F3F"
theme.titlebar_bg_focus                         = theme.titlebar_fg_focus
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#C0C0A2", "#777E76"),
            wibox.container.background(wibox.container.margin(txtclock, 4, 8), "#777E76"),
            arrow("#777E76", "alpha"),
            --]]
            s.mylayoutbox,
        },
